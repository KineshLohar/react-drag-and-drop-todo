  ...
  return (
    <div className="flex flex-col items-stretch justify-start px-16 bg-[#131313] text-white h-screen overflow-y-scroll">
      ...
      <div className=' grid grid-cols-3 gap-4'>
        <TaskColumn title="To Do" tasks={tasks} status="todo" setDraggingTask={setDraggingTask} draggingTask={draggingTask} />
        <TaskColumn title="In Progress" tasks={tasks} status="inProgress" setDraggingTask={setDraggingTask} draggingTask={draggingTask} />
        <TaskColumn title="Done" tasks={tasks} status="done" setDraggingTask={setDraggingTask} draggingTask={draggingTask} />
      </div>
    </div>
  );
}
